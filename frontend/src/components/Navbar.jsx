    ...
    <nav className="fixed inset-y-0 left-0 w-64 bg-gray-900 border-r border-gray-800 flex flex-col justify-between z-40">
      <div>
        ...
        <ul className="flex flex-col space-y-2 text-green-400 ">
          ...
          {/* --- Actual SEARCH LINK below, now enabled! --- */}
          <li>
      ...
      <div className="mb-8 px-7">
        {user ? (
          ...
          <div className="flex gap-3">
            <Link
              to="/login"
              className="flex items-center gap-2 px-4 py-2 border border-green-400 rounded-lg text-green-500 hover:text-black hover:bg-green-500 transition"
            >
              <LogIn size={18} /> Login
            </Link>
            <Link
